...
bash ~/gitrepos/NGS-pipelines/RNAseqPipe3/MakeGeneCoverageBeds-runner.sh $alignFolder $threads $reference $coverage
...
# -o logs \
# -e logs \
#  ~/gitrepos/NGS-pipelines/RNAseqPipe3/MakeGeneCoverageBeds-runner_qsub.sh
