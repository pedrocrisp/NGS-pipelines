...
##### MAplotGeneSet function #####
  ...
  MAplotGeneSetLimma <- function(MArrayLMobject, resultsMatrix, inputList, inputListName, geneSetList, geneSetListName){ 
    limma::plotMA(MArrayLMobject, coef=inputList, cex=0.5, status=resultsMatrix[,geneSetList], values=c(1, -1), col=c("red", "blue"), main=paste0(inputList), legend=F)
...
MAplotGeneSetGreenLimma <- function(MArrayLMobject, resultsMatrix, inputList, inputListName, geneSetList, geneSetListName){ 
  limma::plotMA(MArrayLMobject, coef=inputList, cex=0.5, status=resultsMatrix[,geneSetList], values=c(1, -1), col=c("red", "green"), main=paste0(inputList), legend=F)
  abline(h=0,col="darkgrey")
...
MAplotGeneSet2Limma <- function(MArrayLMobject, geneSetResultsMatrix, DEcallNames, inputList, inputListName, geneSetListName){ 
  limma::plotMA(MArrayLMobject, coef=inputList, cex=0.35, status=geneSetResultsMatrix, values=DEcallNames, col=c("#00FF00",
...
MAplotGeneSet2rLimma <- function(MArrayLMobject, geneSetResultsMatrix, DEcallNames, inputList, inputListName, geneSetListName){ 
  limma::plotMA(MArrayLMobject, coef=inputList, cex=0.35, status=geneSetResultsMatrix, values=DEcallNames, col=c("red",
...
MAplotGeneSet3Limma <- function(MArrayLMobject, geneSetResultsMatrix, DEcallNames, inputList, inputListName, geneSetListName){ 
  limma::plotMA(MArrayLMobject, coef=inputList, cex=0.75, status=geneSetResultsMatrix, values=DEcallNames, col=c("#FF0000", "#00FF00", "#507DC3"), main=paste0(inputListName), legend=F)
  abline(h=0,col="darkgrey")
