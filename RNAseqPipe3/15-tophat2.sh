...
if [ ${numFqFiles} -eq 1 ]
then
#check that these options are correct and check why Kevin's script had "--rg-library ${sample}" and "--rg-platform illumina"
echo tophat --keep-fasta-order -o "$outsam" --solexa-quals --library-type fr-firststrand --min-intron-length 20 --max-intron-length 4000 -G ${refdir}/TAIR10_gen/TAIR10_GFF3_genes.gff ${refdir}/TAIR10_gen/TAIR10_gen $fastqs
tophat --keep-fasta-order -o "$outsam" --solexa-quals --library-type fr-firststrand --min-intron-length 20 --max-intron-length 4000 -G ${refdir}/TAIR10_gen/TAIR10_GFF3_genes.gff ${refdir}/TAIR10_gen/TAIR10_gen $fastqs
...
echo tophat --keep-fasta-order -o "$outsam" --solexa-quals --library-type fr-firststrand --min-intron-length 20 --max-intron-length 4000 -G ${refdir}/TAIR10_gen/TAIR10_GFF3_genes.gff ${refdir}/TAIR10_gen/TAIR10_gen ${fq1} ${fq2}
tophat --keep-fasta-order -o "$outsam" --solexa-quals --library-type fr-firststrand --min-intron-length 20 --max-intron-length 4000 -G ${refdir}/TAIR10_gen/TAIR10_GFF3_genes.gff ${refdir}/TAIR10_gen/TAIR10_gen ${fq1} ${fq2}
