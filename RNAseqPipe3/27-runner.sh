...
workingdir=./
script=$scriptdir/27-bam_to_tdf_stranded.sh
###
...
logdir="./logs/${outdir}_exonBeds.${timestamp}"
mkdir $logdir
...
findSamples | parallel bash $script {} \>logs/${outdir}_exonBeds.${timestamp}/{}.log 2\>\&1
