...
bash ~/gitrepos/NGS-pipelines/RNAseqPipe3/07b-runner.sh $folder $threads $strand $chromoSizes
...
# -o logs \
# -e logs \
#  ~/gitrepos/NGS-pipelines/RNAseqPipe3/07b-runner_qsub.sh
